...
class FileUploadService:
    ...
    async def save_submission_file(self, file: UploadFile, hackathon_id: str, team_id: str) -> str:
        """Save hackathon project submission file"""
        # Validate file type
        allowed_types = ['.zip', '.rar', '.tar', '.gz', '.7z', '.pdf', '.doc', '.docx', '.ppt', '.pptx']
    ...
    async def _save_file(self, file: UploadFile, directory: Path, allowed_types: list) -> str:
