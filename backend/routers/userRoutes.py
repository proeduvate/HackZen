...
from schemas.userSchema import UserCreate,UserMyResponse, UserResponse, TokenResponse, LoginRequest
from services.userService import UserService

router = APIRouter()

@router.post("/register", response_model=UserResponse, status_code=status.HTTP_201_CREATED, response_model_by_alias=True)
