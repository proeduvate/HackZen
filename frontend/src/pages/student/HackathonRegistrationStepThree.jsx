        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row justify-end gap-3 pt-2">
                ...
                <button
                    ...
                    className="w-full md:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                >
                    {isSubmitting ? (
